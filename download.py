...
def fetch_tile(z, x, y, access_token, save_dir, dem):
    ...
    if response.status_code == 200:
        ...
        downloaded_tile = os.path.join(save_dir, f"tile_{dem_cleaned}_{z}zoom_{x}_{y}.png")
...
for z in range(START_ZOOM, END_ZOOM + 1):
    try:
        ...
        print(f"Fetching tile at zoom {z} with coordinates X: {adjusted_x}, Y: {adjusted_y}...")
